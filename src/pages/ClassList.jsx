    ...
    tokenClient.callback = async (resp) => {
      ...
      try {
        ...
        for (const jadwal of classes) {
          ...
          console.log(jadwal.hari, hari, jadwal.jam, startDateTime, endDateTime, mataKuliah, kelas, ruangan)
        ...
        showToast("Events added to your Google Calendar!", "success");
      }
      catch (err) {
        console.error("Error adding event:", err);
        // alert("Failed to add some events. Please check console for details.");
        showToast("Failed to add some events. Please try again", "error");
      }
      finally {
